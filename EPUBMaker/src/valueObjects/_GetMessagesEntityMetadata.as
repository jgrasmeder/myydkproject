...
[ExcludeClass]
internal class _GetMessagesEntityMetadata extends AbstractEntityMetadata
{
    ...
    model_internal static var entityName:String = "GetMessages";
    model_internal static var dependentsOnMap:Object;    
    model_internal static var dependedOnServices:Array =  new Array();
    
    
    model_internal var _instance:_Super_GetMessages;
    model_internal static var _nullStyle:Style = new Style();
    
    public function _GetMessagesEntityMetadata(getMessages : _Super_GetMessages)
    {
        ...
        model_internal::_instance = getMessages;     
    }
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity GetMessages");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
       if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity GetMessages");  
     ...
     override public function getValue(propertyName:String):*    
     {
         ...
         {
         	throw new Error(propertyName + " does not exist for entity GetMessages");
         }     
