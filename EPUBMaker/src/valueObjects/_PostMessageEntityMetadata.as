...
[ExcludeClass]
internal class _PostMessageEntityMetadata extends AbstractEntityMetadata
{
    ...
    model_internal static var entityName:String = "PostMessage";
    model_internal static var dependentsOnMap:Object;    
    model_internal static var dependedOnServices:Array =  new Array();
    
    
    model_internal var _instance:_Super_PostMessage;
    model_internal static var _nullStyle:Style = new Style();
    
    public function _PostMessageEntityMetadata(postMessage : _Super_PostMessage)
    {
        ...
        model_internal::_instance = postMessage;     
    }
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity PostMessage");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
       if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity PostMessage");  
     ...
     override public function getValue(propertyName:String):*    
     {
         ...
         {
         	throw new Error(propertyName + " does not exist for entity PostMessage");
         }     
    ...
    [Bindable(event="propertyChange")]   
    public function get messageStyle():Style
    {
