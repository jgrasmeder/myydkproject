...
import com.ydk.account.web.InterviewCategoryForm;
 ...
 * @author Zhang Yu
 */
public class InterviewCategoryValidator {

	public static void validate(InterviewCategoryForm dataForm, Errors errors) {
