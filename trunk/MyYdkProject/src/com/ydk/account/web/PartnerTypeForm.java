...
public class PartnerTypeForm {
	...
	private PartnerType instance = new PartnerType();
...
//	private Long roleId;
	...
	public PartnerTypeForm(PartnerType instance) {
		super();
	 ...
	 * @param keys
	 */
	public PartnerTypeForm(PartnerType instance, Long[] keys) {
		super();
		this.instance = instance;
		this.keys = keys;
	}
	 ...
	 * @return the instance
	 */
	public PartnerType getInstance() {
		return instance;
	}
	 ...
	 */
	public void setInstance(PartnerType instance) {
		this.instance = instance;
	}
