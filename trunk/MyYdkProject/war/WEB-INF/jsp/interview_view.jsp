...
<table class="table2" align="center" width="95%" border="0" bgcolor="#C9E7E6">
  ...
  <tr align="center">	
    ...
    <td style="text-align:left;" colspan="2">
    	${dataForm.instance.interviewCategory.name}
    </td>
  </tr>
  ...
  <tr align="center">	
    ...
    <td style="text-align:left;" colspan="2">
    	<c:if test="${dataForm.instance.isQa}">问答方式</c:if>
    	<c:if test="${!dataForm.instance.isQa}">非问答方式</c:if>
    </td>
  </tr>
