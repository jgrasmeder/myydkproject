...
<table class="table2"  width="100%" border="0" cellspacing="0" >
  ...
  <c:choose>
	  ...
	  <td>
	  	...
	  	<a href="#" onClick="document.pageDataForm.action='<c:url value="/modifyLibrary.do"/>';
	...
	<c:otherwise>
	  ...
	  <td><a href="<c:url value="/listLibrary.do?itemId=${item.id}&pageNumber=${pageDataList.page}"/>">修改</a></td>
  	</c:otherwise>
  </c:choose>
  </tr>
  </c:forEach>
