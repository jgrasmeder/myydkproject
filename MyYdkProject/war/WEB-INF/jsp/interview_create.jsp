...
<table class="table2" align="center" width="95%" border="0" bgcolor="#C9E7E6">
  ...
  <tr align="center">	
    <td  style="text-align:right">访谈题目</td>
    <td style="text-align:left;" colspan="2">
    	...
    	<script language="javascript"> document.getElementById('instance.title').value="请输入用户名";</script>
  ...
  <tr align="center">	
    ...
    <td style="text-align:left;" colspan="2">
    	<form:select path="instance.interviewCategory.id" cssStyle="width:150px">
    		<c:forEach var="type" items="${typeList}">
    			<option value="${type.id}">${type.name}</option>
    		</c:forEach>
    	</form:select>
    	<form:errors path="instance.interviewCategory.id" cssClass="errors"/>
    	
    </td>
  </tr>
  
  <tr align="center">	
    <td  style="text-align:right">受访者</td>
    <td style="text-align:left;" colspan="2">
    <form:input path="instance.interviewer" onfocus="clear_input_p(this,'#e5fff3');"
    	onblur="setbg_p(this,'white', '请输入受访者信息');"
    	onchange="check_input_p(this, 'white');"/>
    <script language="javascript"> document.getElementById('instance.interviewer').value="请输入受访者信息";</script>
    <form:errors path="instance.interviewer" cssClass="errors"/>
    </td>
  </tr>
  
  <tr align="center">	
    <td  style="text-align:right">记者</td>
    <td style="text-align:left;" colspan="2">
    <form:input path="instance.reporter" onfocus="clear_input_p(this,'#e5fff3');"
    	onblur="setbg_p(this,'white', '请输入记者信息');"
    	onchange="check_input_p(this, 'white');"/>
    <script language="javascript"> document.getElementById('instance.reporter').value="请输入记者信息";</script>
  ...
  <tr align="center">	
    ...
    <td style="text-align:left;" colspan="2">
    <form:input path="instance.location" onfocus="clear_input_p(this,'#e5fff3');"
    	onblur="setbg_p(this,'white', '请输入地点信息');"
    	onchange="check_input_p(this, 'white');"/>
    <script language="javascript"> document.getElementById('instance.location').value="请输入地点信息";</script>
  ...
  <tr align="center">	
    <td  style="text-align:right">问答方式</td>
    <td style="text-align:left;" colspan="2">
    	<form:select path="instance.isQa" cssStyle="width:150px">
