...
<table class="table2" align="center" width="95%" border="0" bgcolor="#C9E7E6">
  ...
  <tr align="center">	
    ...
    <td style="text-align:left;" colspan="2">
    	<form:select path="instance.eventCategory.id" cssStyle="width:150px">
    		<c:forEach var="type" items="${typeList}">
    			<option value="${type.id}">${type.name}</option>
    		</c:forEach>
    	</form:select>
    	<form:errors path="instance.eventCategory.id" cssClass="errors"/>
  ...
  <tr align="center">	
    ...
    <form:input path="instance.order" onfocus="clear_input_p(this,'#e5fff3');"
    	onblur="setbg_p(this,'white', '10');"
    	onchange="check_input_p(this, 'white');"/>
    <script language="javascript"> document.getElementById('instance.order').value="10";</script>
